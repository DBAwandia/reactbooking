  ...
  return (
    ...
    {level?.map((item,i)=>{
      return <div className='orderStats' key={i}>
        ...
        <div className='orderstartss'>
        <h1>PRICE:</h1><p style={{color: "lightgreen",fontSize: 27, marginLeft: 15,letterSpacing: 2}}> ${item.cheapestPrice*days*options.room}</p>
        </div>
        <div className='orderstartss'>
        ...
        return <div className='paymentContainer' key={i}>
          ...
          <div className='buttonContainer'>
            <StripeCheckout
              ...
              image="/images/waiter.jpg" // the pop-in header image (default none)
